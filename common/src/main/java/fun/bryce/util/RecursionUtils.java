...
public final class RecursionUtils
{
     ...
     * @return 父子主键
     */
    public static List<Serializable> listIds(List<? extends ParentChildrenRecursion> models, List<Serializable> idContainer)
    {
     ...
     * </pre>
     */
    public static List listToTree(List<? extends ParentChildrenRecursion> list, Serializable parentId)
    {
     ...
     */
    public static List treeInnerFindParent(List<? extends ParentChildrenRecursion> list, Serializable parentId)
    {
        if (CollectionUtils.isEmpty(list))
        {
     ...
     * </pre>
     */
    public static <T extends ParentChildrenRecursion> T treeInnerFindOneself(List<? extends ParentChildrenRecursion> list, Serializable oneselfId)
    {
        if (CollectionUtils.isEmpty(list))
        {
            return null;
    ...
    public static <T extends ParentChildrenRecursion> T innerFindOneself(List<? extends ParentChildrenRecursion> list, Serializable oneselfId)
    {
        if (CollectionUtils.isEmpty(list))
        {
            return null;
     ...
     * @return
     */
    private static List<? extends ParentChildrenRecursion> tree(Serializable parentId, Map<Serializable, List<ParentChildrenRecursion>> content)
    {
     ...
     * @return
     */
    public static List elementTreeToList(List<? extends ParentChildrenRecursion> trees, List<ParentChildrenRecursion> container)
    {
        ...
        // 清空 children 内容
        return container.parallelStream().map(element -> element.setChildren(null)).collect(Collectors.toList());
    }

    /**
     * @see #elementTreeToList(List, List)
     */
    public static List elementTreeToList(ParentChildrenRecursion tree, List<ParentChildrenRecursion> container)
    {
     ...
     * @return
     */
    public static List findListInnerThisAllChildrenToList(List<? extends ParentChildrenRecursion> list, Serializable thisElementId)
    {
        // 1. 组织树形结构关系
